...
from data_pipeline_tools.runn_tools import reference_value_get, handle_runn_rate_limits
...
def load_config(project_id, service) -> dict:
    return {
        ...
        "table_name": (
            os.environ.get("TABLE_NAME") if os.environ.get("TABLE_NAME") else "projects"
        ),
        "location": (
