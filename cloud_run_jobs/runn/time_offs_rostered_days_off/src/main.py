...
service = "Data Pipeline - Time off (Rostered days off)"
...
def load_config(project_id, service, ingest_time) -> dict:
    return {
        ...
        "table_name": target_daily_partition(
            os.environ.get("TABLE_NAME") or "time_offs_rostered_days_off", ingest_time
        ),
...
def main(data: dict, context):
    ...
    pages = fetch_all(
        ...
        base_url="https://api.runn.io/time-offs/rostered-off/",
        service=service,
        page_size=200
    )
